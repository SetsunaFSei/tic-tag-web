  ...
  return (
    ...
    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <div className="flex items-center justify-between">
        <button onClick={onLoginPress} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
          Sign In
        </button>
